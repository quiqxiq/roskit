...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if (isset($_POST['name'])) {
    ...
    $record = '; :local mac $"mac-address"; :local time [/system clock get time]; :local srv $server; /system script add name="$date-|-$time-|-$user-|-'.$price.'-|-$address-|-$mac-|-' . $validity . '-|-'.$name.'-|-$srv" owner="$month$year" source="$date" comment="mikhmon"';
