...
func (r UserRole) Valid() bool {
	switch r {
	case UserRoleOwner, UserRoleAdmin, UserRoleStaff, UserRoleSuperAdmin:
		return true
	}
	return false
}
...
type User struct {
	...
	TenantID     *uint          `gorm:"index;uniqueIndex:idx_users_tenant_username,where:deleted_at IS NULL"                                 json:"tenant_id"`
